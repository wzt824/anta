...
function shuju(){
    // let aa = getCookie("proBuycolor");
    $(".color").html(getCookie("proBuycolor"));//颜色
    $(".size").html(getCookie("proBuysize"));//尺码
    $(".lis3").find("img").attr("src",getCookie("proBuyimg"));//图片
    $(".tag").html(getCookie("proBuytagValue"));//吊牌价
    let ss =getCookie("proBuyShopValue");//出售价
    $(".price").html(ss);//出售价
        ...
        for(var i=0;i<data.length;i++){
            if(data[i].goodsId == getCookie("proXq")){
                productPart += " <ul class='car_uls'>\
                    ...
                    <li class='lis3'><img src='' alt=''></li>\
                    <li class='lis4'>\
                        <h3>"+data[i].goodsName+" - "+data[i].goodsId+"</h3>\
                        <p>颜色：<span class='color'></span>尺码：<span class='size'></span></p>\
                    </li>\
                    <li class='lis5'>\
                        <p class='underline'>￥<span class='danjia tag'></span></p>\
                        <p>￥<span class='danjia price'></span></p>\
                    </li>\
                    <li class='lis6'>\
                        <div class='span_info'>\
